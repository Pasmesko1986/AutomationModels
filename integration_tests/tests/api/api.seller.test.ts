...
import { IdentityApi } from "../../src/api/identity-api-seller";
import { paymentBody, quoteCollectionBody, SettleBody } from "./data-seller"; //Importa el request Body /data.ts
...
describe("Tests de integración", () => {
  ...
  describe("Test de generar un quote y aceptarlo", async () => {
    ...
    console.log("Generacion de un quote Seller y aceptarlo");
